  ...
  return (
    ...
    >
      <div className="relative w-full" style={{ maxWidth: "min(100vw, calc(100vh * 16 / 9))", aspectRatio: "16 / 9" }}>
        ...
        {/* ============ HUD (in-game) ============ */}
        {ui && ui.phase !== "menu" && ui.phase !== "heaven" && ui.phase !== "gameover" && ui.phase !== "reveal" && ui.phase !== "descending" && ui.phase !== "ascending" && (
          <div className="absolute inset-0 pointer-events-none">
            {/* score — top left */}
            <WoodPanel className="absolute top-2 left-2 px-3 py-2 text-center anim-slide-down">
            ...
            {ui.overfed && ui.overfedLeft > 0 && (
              <div
                className={`absolute bottom-2 left-2 pointer-events-none panel-dark px-3 py-2 border-2 anim-pop ${
            ...
            {/* belly — bottom center */}
            <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex items-end gap-2">
              <div className="flex flex-col items-center gap-1">
                {ui.hint && (
                  <div className="font-pixel text-[7px] text-yellow-100/95 bg-black/55 px-2 py-1 border border-yellow-200/30 text-center anim-rise">
                    {ui.hint}
                  </div>
                )}
            ...
            <div className="absolute left-2 top-24 flex flex-col gap-1 max-w-[150px]">
              {ui.missions.map((m) => (
                <div
                  key={m.id}
            ...
            <div className="absolute bottom-2 right-2 flex flex-col items-end gap-1.5 pointer-events-auto">
              <div className="flex gap-1.5 flex-wrap justify-end">
                ...
                <button className="btn-pixel btn-ghost !px-2 !py-1.5 !text-[8px]" onClick={() => click(() => setModal("settings"))}>
                  ⚙️
                </button>
              </div>
              {showGuide && save && (
            ...
            {/* toasts */}
            <div className="absolute right-2 top-16 flex flex-col gap-2 items-end pointer-events-none">
              {toasts.map((t) => (
        ...
        {ui?.phase === "paused" && (
          <div className="absolute inset-0 bg-black/60 flex items-center justify-center pointer-events-auto anim-rise">
            <WoodPanel className="px-8 py-6 flex flex-col items-center gap-3 text-center">
              ...
              <button className="btn-pixel btn-brown !text-[10px] w-44 justify-center" onClick={() => click(() => { setModal("settings"); })}>⚙️ SETTINGS</button>
          ...
          <div className="absolute inset-0 pointer-events-none flex flex-col items-center justify-between py-3 menu-atmosphere">
            ...
            <div className="flex flex-col items-center gap-2 pointer-events-auto">
              ...
              <div className="flex gap-2">
                ...
                <button className="btn-pixel btn-blue !text-[8px] w-[106px] justify-center" onClick={() => click(() => setModal("settings"))}>
                  ⚙️ SETTINGS
                </button>
              </div>
